...
const faqs = [
  ...
  },
  {
    ...
    answer: `Savri launches in June 2026 across Delhi, Gurgaon, and Noida first. We are expanding to more areas quickly after launch. Join the waitlist and tell us your area — we will notify you the moment Savri is available in your neighbourhood.`,
  },
  {
  ...
  },
  {
    ...
    answer: `We are actively hiring verified chefs across Delhi, Gurgaon, and Noida right now. Savri offers flexible working hours, consistent bookings, and the chance to build your own loyal client base in premium Delhi homes. Scroll down to the chef section and apply directly. IHM graduates are especially encouraged to apply.`,
  },
  {
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            >
              ...
              <span className="text-base">founder@savri.co.in</span>
            </a>
