...
const pillars = [
  ...
  },
  {
    ...
    description:
      "Home-cooked food by a real chef costs less than you think. More affordable than your weekly delivery spend. Starting from ₹549 for a home-cooked meal for 2–3 people. Less than your last Zomato order.",
  },
  {
    icon: Sparkles,
    title: "Built with AI",
