          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                ...
                Earn ₹800–₹1,500 per booking. Paid within 48 hours via UPI.
              </p>
              ...
              >
                ...
                <p className="text-dark/60 text-sm mt-4">
                  Apply in 5 minutes — fill our chef application form:{" "}
                  <a
                    href="https://bit.ly/savri-chef"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-2 bg-dark text-cream px-5 py-2 rounded-lg text-sm font-medium transition-all duration-150 hover:bg-dark/80 hover:scale-[1.02] active:scale-[0.98]"
                  >
                    Apply Now
                  </a>
                </p>
