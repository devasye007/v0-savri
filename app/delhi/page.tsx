...
export const metadata: Metadata = {
  title: "Private Chef in Delhi | Party Bookings from ₹6,399",
  description:
    "Hire a verified private chef at home in Delhi. Regular bookings from ₹549. Party bookings from ₹6,399 — 4 snacks, 4 mains, 2 sides, 2 desserts. We serve South, Central, North and West Delhi.",
  keywords: [
    "private chef Delhi",
  ...
  openGraph: {
    ...
    description:
      "Book a verified private chef at home in Delhi. Party bookings from ₹6,399. South, Central, North and West Delhi.",
    images: [{ url: "/images/party-mains.jpg", width: 1200, height: 630, alt: "Savri private chef Delhi" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Private Chef in Delhi | Savri Party Bookings",
    description: "Party bookings from ₹6,399. Verified chefs across Delhi.",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Savri's regular private chef bookings in Delhi start at ₹549 for 1–3 guests. Our party booking — 4 snacks, 4 mains, 2 sides and 2 desserts — is ₹6,399 anywhere in Delhi with no travel surcharge.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Our Delhi party booking at ₹6,399 is designed for birthdays, anniversaries, in-law dinners and intimate house parties of roughly 10–20 guests. A verified chef cooks live in your kitchen and cleans up after.",
      },
    },
  ],
}
