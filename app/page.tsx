...
import { OccasionSelectorSection } from "@/components/sections/occasion-selector-section"
  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        {/* Interactive occasion selector — shows menus per occasion */}
        <OccasionSelectorSection />
