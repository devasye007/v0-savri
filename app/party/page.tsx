...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "private party chef Gurugram",
    "party chef Noida",
    "home party chef Delhi",
    "chef for kitty party Delhi",
    "chef for house party Delhi NCR",
    "party booking chef India",
    "private chef party catering Delhi",
