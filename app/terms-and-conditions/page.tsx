      ...
      <main className="bg-cream pt-32 text-dark">
        <section className="container mx-auto px-6 pb-20">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 font-serif text-5xl font-semibold md:text-6xl">Terms & Conditions</h1>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl rounded-[2rem] border border-dark/8 bg-white p-8 shadow-[0_16px_40px_rgba(26,26,26,0.05)] md:p-10">
              <div className="space-y-8 text-sm leading-7 text-dark/72 md:text-base">
                <section>
                  <h2 className="font-serif text-3xl font-semibold text-dark">1. Bookings</h2>
                  <p className="mt-3">
                ...
                <section>
                  <h2 className="font-serif text-3xl font-semibold text-dark">2. Pricing</h2>
                  <p className="mt-3">
                ...
                <section>
                  <h2 className="font-serif text-3xl font-semibold text-dark">3. Customer Responsibilities</h2>
                  <p className="mt-3">
                ...
                <section>
                  <h2 className="font-serif text-3xl font-semibold text-dark">4. Cancellations</h2>
                  <p className="mt-3">
                ...
                <section>
                  <h2 className="font-serif text-3xl font-semibold text-dark">5. Service Standards</h2>
                  <p className="mt-3">
